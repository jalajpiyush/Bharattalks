        ...
        {features.map((feature, idx) => {
          ...
          return (
            <motion.div
              ...
              className="relative overflow-hidden rounded-3xl glass-panel p-8 shadow-xl transition-all duration-300 border border-white/5 hover:border-[#10a37f]/20 group"
            >
              ...
              <div className="absolute -bottom-10 -right-10 w-24 h-24 bg-[#10a37f]/5 rounded-full blur-2xl group-hover:bg-[#10a37f]/15 transition-all duration-300" />
              ...
              <h3 className="text-xl font-bold font-display text-white mb-3 group-hover:text-[#10a37f] transition-colors duration-300">
                {feature.title}
              </h3>
